...
advantage of these methods. This can be explained because of the time
...
In future work, other MOEAs, such as SPEA will be compared, with new
...
quantities of islands/processors, will be used to compare the different
methods. Also, a scalability study will be performed, being the
transmission time between islands a relevant issue to
study. New benchmarks and real problems will also be  used to validate
our approach. 
