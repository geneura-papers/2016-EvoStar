...
\begin{table}[h!tb]
	...
	\begin{center}
		...
		\end{tabular}
		\caption{Comparisson of theorical archetypes in the Monomytha and their interpretations in {\sf ColorForms}.}
...
The source code and the experiments are freely downloadable and modifiable from the official project's page~\footnote{Details omitted for double-blind reviewing}.
