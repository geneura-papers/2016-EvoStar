...
As the introduction remarked, following Szymanezyk et al. in
...
dynamic and will take part in the decisions that the piece makes, for
instance, the joy of the piece will be influenced by the ones with
